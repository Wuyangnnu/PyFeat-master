...
def main(args):
    ...
    global fileName
    if args.fasta != None:
        fileName = args.fasta[args.fasta.rfind("\\")+1:args.fasta.rfind(".")-1]
        print(fileName)
    import read
    ...
    if args.optimumDataset == 1:
        ...
        import save
        save.saveCSV(X_train, Y_train, 'optimum' , fileName)
...
if __name__ == '__main__':
    ...
    p.add_argument('-pseudo', '--pseudoKNC', type=int, help='Generate feature: X, XX, XXX, XXX', default=0,
                   choices=[0, 1])
